...
SODA.recipe.add(
    ...
    SODA.icon.icons_1_to_1_vertical("discharged-primitive-battery", "purple-ore"), {allow_as_intermediate = false} -- 1 per 80
)
...
SODA.recipe.add(
    ...
    SODA.MATS.green.tint, true, SODA.icon.icons_1_to_1_vertical("spent-nuclear-UV-emitter", "green-ore"), {allow_as_intermediate = false}
) -- 1 per 9
...
-- red
SODA.fluid.add("hot-air", "1h", subgroup, SODA.MATS.white.tint, {folders = "fluids"}, false, {max_temperature = 315, gas_temperature = 0, heat_capacity = 0.04 .. "kJ"})
...
SODA.recipe.add(
    ...
    nil, SODA.MATS.yellow.tint, nil, nil, {emissions_multiplier = 0.5}
)
...
SODA.recipe.add(
    ...
    nil, 1.6, subgroup, "1j", SODA.MATS.green.tint, true, SODA.icon.icons_2_to_1("green-acid", "stone", "steam"), {emissions_multiplier = 3, allow_as_intermediate = false}
)
